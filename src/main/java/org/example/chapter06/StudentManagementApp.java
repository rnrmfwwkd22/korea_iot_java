...
public class StudentManagementApp {
    ...
    //      : 하나의 파일에서 public 단위의 클래스는한 개만 지정 가능
    ...
    public static void main(String[] args) {
        ...
        //학생 추가
        addStudent(1, "김뽕뽕", 20, "IoT", 3.8);
        addStudent(2, "김킥킥", 21, "IoT", 3.9);
        addStudent(3, "전태태", 22, "IoT", 3.7);
        addStudent(4, "전긍긍", 23, "IoT", 3.8);
