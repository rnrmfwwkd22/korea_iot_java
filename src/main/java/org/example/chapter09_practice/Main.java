...
public class Main {
    public static void main(String[] args) {
        ...
        // 사용자 추가
        userService.addUser(new User(1,"권민민","qwe123@example.com"));
        userService.addUser(new User(2,"안미미","asd123@example.com"));
        userService.addUser(new User(3,"김승승","zxc123@example.com"));
...
//            System.out.println(user.toString());
        ...
        // 이메일 수정
        try {
            userService.updateUserEmail(5,"asd000@example.com");
        ...
        try {
            ...
            System.out.println("조회 실패: " + e.getMessage()); // 조회 실패ㅣ 사용자 ID에 100값이 없습니다.
        }
        ...
        try {
            ...
            System.out.println("삭제 실피: " + e.getMessage());
        }

        System.out.println("ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ");
        // 특정 이름 조회 (필터링)
        String searchname = "김승승";
