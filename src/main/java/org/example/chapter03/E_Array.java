...
// 장점) 기본 데이터 타입 사용 기능 = int, char, boolean 등
...
//        자바 정적 배열
        ...
        System.out.println(Arrays.toString(numvers));
...
//        장점)
//            크기 제한 X, 다향한 평의 메서드가 존재(add, remove, set 등)
//        단점)
//            기본 타입 사용 불가
//            내부적으로 배열이므로, 중간 삽입/삭제 시 성능 저하 기능성

//        cf)ArrayList의 경우 기본 데이터 타입 사용 X
//        : 참조 데이터 타입만 가능! (Wrapper 클래스 사용!)

//        cf) Wrapper 클래스
//        :  자바의 기본 타입으 객체 형태로 감싸서 사용할 수 있도록 만든 클래스
...
//        >> 내부 데이터를 확인하기 쉽게 문자열로 정리된 형태를 제동 toString() 재정의
