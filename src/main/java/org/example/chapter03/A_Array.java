...
public class A_Array { // 클래스명 == 파일명 (파일명은 대문자로 시작! + UpperCamelcase 사용)
    ...
    public static void main(String[] args) {
        /*   === 배열(Array) ===
             : 같은 타입의 "여러 변수"를 하나의 집합으로 묶어서 처리하는 구조
             - 데이터를 "연속적"으로 저장
             - 순서 0 (index 인텍스 번호 - 0부터 시작하여 1씩 증가도디는 값)
...
//        cf)참조 자료형 - 주소값이 저장
        // 데이터 배열이 저장된 첫 번 쨰 메모리 주소가 저장 (인덱스버놓 0번의 주소)
...
//        >> 숫자(0), 문자열 (""). 논리형(false)
        ...
        scores1[0] = 80;
        scores1[1] = 90;
        scores1[2] = 85;  // 전체 요소의 개수 - 1 == 마지막 인텍스 번호
        ...
        System.out.println(arr3);  //     공백이 4개있음
        System.out.println(arr4);  //[Z@5305068a
