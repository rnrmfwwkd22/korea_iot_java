...
public class JavaLang {
    public static void main(String[] args) {
        ...
        MyClass myClass1 = new MyClass(1, "김붕붕");
        System.out.println(myClass1); // MyClass[ID: 1 / NAME: 김붕붕]
        System.out.println(myClass1.toString()); // MyClass[ID: 1 / NAME: 김붕붕]
        System.out.println(myClass1.displayInfo()); // MyClass[ID: 1 / NAME: 김붕붕]
        ...
        System.out.println("myClass1과 myClass2의 비교: " + myClass1.equals(myClass3));
        ...
        System.out.println(message); // Merry Christmas! - 문자열기능을 활용해도 기본 데이터 변환 X
        // >> 문자열의 불변성
