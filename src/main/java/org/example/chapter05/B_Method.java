...
/*
        ...
        1) 메서드의 구조: 선언부, 구현부
            ...
            cf) 변수 '선언'
                ...
                >> 필요한 개수만큼 선언! 데이터타입 생략 불가! 사용 시 테이터 생략 불가!

                +) 구현부
                : 반환타입이 void가 아닐 경우 반드시! 'return 반환타입데이터;'
                >> 반환값은 명시된 타입과 일치하거나 자동형 변환 가능
  */
